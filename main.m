...
for t = 1:1:T
    t
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%use the part below while using either the benefit by dist method or max no
%of nodes hearing method
    if(t == 1)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%use this part to use the scan.m for the path os seed
%     if(t == 1)
%         nodePositionNew = newNodePosition(nodePosition,V_max);
%         [ERLeft,ERRight] = estimativeRegion(nodePositionNew,V_max);
%         dir0 = zeros(noOfSeeds,1);
%         dir1 = zeros(noOfSeeds,1);
%         seedPositionNew = seedPosition;
%     end
%     if(t ~= 1)
%         nodePositionNew = newNodePosition(nodePosEstmtd,V_max);
...
%     end
%     
%     [seedPosNew,dir1new,dir0new] = scan(seedPositionNew,dir1,dir0,V_max,r,net);
%     
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
